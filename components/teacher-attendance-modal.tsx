      ...
      <DialogContent className="max-w-[95vw] md:max-w-[500px]">
        ...
        <div className="flex gap-3 justify-end">
          <Button
            ...
            className="font-bold px-2 py-1 text-xs sm:text-sm"
          ...
          <Button
            ...
            className="bg-gradient-to-r from-[#D4AF37] to-[#C9A961] hover:from-[#C9A961] hover:to-[#BFA050] text-[#023232] font-bold px-2 py-1 text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={isSubmitting}
          >
